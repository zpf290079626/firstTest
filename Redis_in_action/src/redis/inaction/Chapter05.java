...
public class Chapter05 {
	private static final String IP = "192.168.200.247";
    ...
    private static final SimpleDateFormat ISO_FORMAT =
        new SimpleDateFormat("yyyy-mm-dd'T'00mm00");
    static{
...
//            CSVParser parser = new CSVParser(reader);
            ...
            int count = 0;
            List<CSVRecord> line = null;
            while ((line = parser.getRecords()) != null){
//                String startIp = line.get(0) > 1 ? line[0] : "";
